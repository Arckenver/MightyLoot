...
public class ConfigHandler
{
	...
	public static void setToDefaultConfig(CommentedConfigurationNode conf)
	{
		...
		node.getNode("items").getNode("minecraft:emerald").setValue("2-12");
		node.getNode("items").getNode("minecraft:diamond").setValue("4-16");
		node.getNode("items").getNode("minecraft:gold_ingot").setValue("10-32");
		node.getNode("items").getNode("minecraft:iron_ingot").setValue("32-128");
		node.getNode("items").getNode("minecraft:coal").setValue("32-128");
		node.getNode("items").getNode("minecraft:redstone").setValue("0-256");
		node.getNode("items").getNode("minecraft:flint").setValue("0-64");
		node.getNode("items").getNode("minecraft:stone").setValue("64-256");
		node.getNode("items").getNode("minecraft:dirt").setValue("0-128");
		node.getNode("items").getNode("minecraft:gravel").setValue("0-64");
		
		node = conf.getNode("lootTypes").getNode("nether");
		node.getNode("display").setValue("{\"text\":\"Nether Loot\",\"color\":\"dark_purple\"}");
		node.getNode("items").getNode("minecraft:netherrack").setValue("128-256");
		node.getNode("items").getNode("minecraft:nether_brick").setValue("64-384");
		node.getNode("items").getNode("minecraft:nether_wart").setValue("0-64");
		node.getNode("items").getNode("minecraft:soul_sand").setValue("0-128");
		node.getNode("items").getNode("minecraft:glowstone").setValue("32-128");
		node.getNode("items").getNode("minecraft:quartz").setValue("128-512");

		node = conf.getNode("lootTypes").getNode("material");
		node.getNode("display").setValue("{\"text\":\"Material Loot\",\"color\":\"gray\"}");
		node.getNode("items").getNode("minecraft:stone").setValue("64-128");
		node.getNode("items").getNode("minecraft:dirt").setValue("64-128");
		node.getNode("items").getNode("minecraft:sand").setValue("64-128");
		node.getNode("items").getNode("minecraft:glass").setValue("64-128");
		node.getNode("items").getNode("minecraft:brick_block").setValue("64-128");
		node.getNode("items").getNode("minecraft:obsidian").setValue("0-64");
		node.getNode("items").getNode("minecraft:log").setValue("64-128");

		node = conf.getNode("lootTypes").getNode("mobs");
		node.getNode("display").setValue("{\"text\":\"Mob Loot\",\"color\":\"red\"}");
		node.getNode("items").getNode("minecraft:rotten_flesh").setValue("64-128");
		node.getNode("items").getNode("minecraft:spider_eye").setValue("0-64");
		node.getNode("items").getNode("minecraft:bone").setValue("0-64");
		node.getNode("items").getNode("minecraft:ender_pearl").setValue("0-32");
		node.getNode("items").getNode("minecraft:blaze_rod").setValue("0-64");
		node.getNode("items").getNode("minecraft:gunpowder").setValue("0-64");
		node.getNode("items").getNode("minecraft:ghast_tear").setValue("0-16");
		node.getNode("items").getNode("minecraft:slime_ball").setValue("0-32");
		node.getNode("items").getNode("minecraft:string").setValue("0-64");

		node = conf.getNode("lootTypes").getNode("goldish");
		node.getNode("display").setValue("{\"text\":\"Goldish Loot\",\"color\":\"yellow\"}");
		node.getNode("items").getNode("minecraft:gold_block").setValue("4-16");
		node.getNode("items").getNode("minecraft:gold_ingot").setValue("32-128");
		node.getNode("items").getNode("minecraft:gold_nugget").setValue("64-256");

		node = conf.getNode("lootTypes").getNode("food");
		node.getNode("display").setValue("{\"text\":\"Food Loot\",\"color\":\"blue\"}");
		node.getNode("items").getNode("minecraft:bread").setValue("64-256");
		node.getNode("items").getNode("minecraft:potato").setValue("16-32");
		node.getNode("items").getNode("minecraft:carrot").setValue("16-32");
		node.getNode("items").getNode("minecraft:melon").setValue("16-32");
		node.getNode("items").getNode("minecraft:pumpkin").setValue("0-64");
		node.getNode("items").getNode("minecraft:reeds").setValue("0-64");
		node.getNode("items").getNode("minecraft:fish").setValue("16-32");
		node.getNode("items").getNode("minecraft:cake").setValue("0-16");
		
		conf.getNode("worlds").getNode("world").getNode("frequency").setValue(600);
		conf.getNode("worlds").getNode("world").getNode("minX").setValue(-2500);
		conf.getNode("worlds").getNode("world").getNode("minY").setValue(10);
		conf.getNode("worlds").getNode("world").getNode("minZ").setValue(-2500);
		conf.getNode("worlds").getNode("world").getNode("maxX").setValue(2500);
		conf.getNode("worlds").getNode("world").getNode("maxY").setValue(50);
		conf.getNode("worlds").getNode("world").getNode("maxZ").setValue(2500);
		conf.getNode("worlds").getNode("world").getNode("lootTypes").getNode("mine").setValue(20);
		conf.getNode("worlds").getNode("world").getNode("lootTypes").getNode("nether").setValue(16);
		conf.getNode("worlds").getNode("world").getNode("lootTypes").getNode("material").setValue(16);
		conf.getNode("worlds").getNode("world").getNode("lootTypes").getNode("mobs").setValue(16);
		conf.getNode("worlds").getNode("world").getNode("lootTypes").getNode("goldish").setValue(16);
		conf.getNode("worlds").getNode("world").getNode("lootTypes").getNode("food").setValue(16);
	}
